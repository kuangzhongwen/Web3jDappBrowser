...
/**
 * Wrap android.webkit.WebSettings
 *
 * @author kuang on 2018/01/08.
 */
final class WrapWebSettings extends WebSettings {
    ...
    public void setJavaScriptEnabled(boolean flag) {
        origin.setJavaScriptEnabled(flag);
    }
    ...
    public void setSafeBrowsingEnabled(boolean b) {
        origin.setSafeBrowsingEnabled(b);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void setDisabledActionModeMenuItems(int i) {
        origin.setDisabledActionModeMenuItems(i);
    }
}
