...
window.Trust.init(rpcURL, {
  ...
  processTransaction: function (tx, cb){
    ...
    ctxcWeb3Browser.signTransaction(id, tx.to || null, tx.value, nonce, gasLimit, gasPrice, data);
  },
  signMessage: function (msgParams, cb) {
    ...
    Trust.addCallback(id, cb)
    ctxcWeb3Browser.signMessage(id, data);
  },
  signPersonalMessage: function (msgParams, cb) {
    ...
    Trust.addCallback(id, cb)
    ctxcWeb3Browser.signPersonalMessage(id, data);
  },
  signTypedMessage: function (msgParams, cb) {
    const { data } = msgParams
    const { id = 8888 } = msgParams
    Trust.addCallback(id, cb)
    ctxcWeb3Browser.signTypedMessage(id, JSON.stringify(data))
  }
}, {
    address: addressHex,
...
//window.web3.currentProvider = new Trust({
//                                    address: addressHex,
//                                    chainId: chainID,
//                                    rpcUrl: rpcURL
//                                  });
